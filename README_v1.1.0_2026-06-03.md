...
This is a clean-build release. The original large vehicle-circle Home Screen remains the primary navigation method.

## Key Updates in v1.1.0

- User-facing name changed to RGB Mileage.
